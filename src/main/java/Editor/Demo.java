...
import static Editor.IOUtil.ioResourceToByteBuffer;
...
class Demo {
    ...
    static class DemoData {
        ...
        final ByteBuffer entypo           = loadResource("resources/Game/Fonts/nativee.ttf", 40 * 1024);
        final ByteBuffer RobotoRegular    = loadResource("resources/Game/Fonts/nativee.ttf", 150 * 1024);
        final ByteBuffer RobotoBold       = loadResource("resources/Game/Fonts/nativee.ttf", 150 * 1024);
        final ByteBuffer NotoEmojiRegular = loadResource("resources/Game/Fonts/nativee.ttf", 450 * 1024);
    ...
    static int loadDemoData(long vg, DemoData data) {
        ...
        for (int i = 0; i < 12; i++) {
            String     file = "resources/Game/Textures/block.png";
