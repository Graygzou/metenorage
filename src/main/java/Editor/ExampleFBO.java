...
public final class ExampleFBO extends Demo {
    ...
    private static final ByteBuffer RobotoRegular = loadResource("resources/Game/Fonts/nativee.ttf", 150 * 1024);
    private static final ByteBuffer RobotoBold    = loadResource("resources/Game/Fonts/nativee.ttf", 150 * 1024);
